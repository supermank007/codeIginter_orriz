 ...
 */
$config['site_title']                 = "Orriz";       // Site Title, example.com
$config['admin_email']                = "noreply@orriz.com"; // Admin Email, admin@example.com
...
$config['user_expire']                = 1296000;             // How long to remember the user (seconds). Set to zero for no expiration
