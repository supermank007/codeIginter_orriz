...
//        $data['friend_list']=$this->member_model->friend_list($this->session->userdata('user_id'));
        $this->type = 'gallery';
    ...
    public function add_photos()
    {
        ...
        $data['friend_list'] = $this->member_model->friend_list($this->session->userdata('user_id'));
        $this->load->view('photos/addPhotos', $data);
    }
    ...
    public function upload_ajax()
    {
        ...
        if (!$tmp) {
            exit(json_encode(['result' => 'error', 'message' => 'Server error']));
        }
