...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="join-form">
                <form role="form" method="post" action="<?php echo base_url(); ?>public_gate/register_member">
                    ...
                    <div class="join-form-body">
                        ...
                        <div class="join-free-form-text">
                            <p>By clicking Sign up, you are indicating that you have read & agree to the <a
                                        href="<?php echo base_url(); ?>public_gate/#">Terms of Service</a> and <a
                                        href="<?php echo base_url(); ?>public_gate/#">Privacy Policy</a>.</p>
                        </div>
