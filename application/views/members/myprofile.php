    ...
    <div class="myprofile-box">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="referral-content-container">
                    <div class="referral-number">
                        <h3><?php echo ucfirst($users_data[0]['first_name']) . ' ' . ucfirst($users_data[0]['last_name']); ?></h3>
                        ...
                        <table style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <!--                                <td>-->
                                <?php //if ($users_data[0]['is_login'] == "1") {
                                //                                        echo 'Online Now!';
                                //                                    } else {
                                //                                        echo date($users_data[0]['last_seen']);
                                //                                    } ?><!--</td>-->
                            </tr>
                            <tr>
                                <td>Profile Views</td>
                                <td>:</td>
                                <td><?= $users_data['count_views'] ?> times</td>
                            </tr>
                            <tr>
                                <td>Member Since</td>
                                <td>:</td>
...
<script>
    ...
    $('#set_profile_url').click(function () {
        ...
        $.ajax(
            {
                type: "post",
                url: "<?= base_url('dashboard/set_profile_url') ?>",//URL changed
                data: data,
                success: function (response) {
                    switch (response) {
                        case '0':
                            swal(
                                'Error',
                                'Profile url must not be less than 5 characters',
                                'error'
                            );
                            break;
                        case '1':
                        ...
                        case '2':
                            swal(
                                'Error',
                                'Profile url containes disallowed characters or begins with digit',
                                'error'
                            );
                            break;
                        case '3':
