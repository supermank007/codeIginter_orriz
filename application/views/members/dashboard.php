...
<head>
    ...
    <!--    <link rel="stylesheet" href="--><?php //echo base_url(); ?><!--public/css/chatmessage.css"/>-->
                    ...
                    success: function (response) {
                        ...
                        if (IS_JSON) {
                            if (data.response == 'ok') {
                                ...
                                swal('Error', 'Invalid video link', 'error');
                            }
                        } else {
                            swal('Error');
                        }
    ...
    <div class="row">
                ...
                <div class="post-ad-form">
                    <form role="form" method="post" action="<?php echo base_url('dashboard/postad'); ?>
                        ...
                        <div class="form_t_data_desk">
                            ...
                            <div>
                                <input type="hidden" name="points" value="<?= $me->points ?>"/>
                            </div>
                            <div class="post-ad-form-group">
        ...
        <div class="col-sm-9">
            ...
            <div class="col-xs-12">
                                ...
                                <div class="browse_box">
                                    <div class="t-img-wrap">
                                        ...
                                        <div class="user-control">
                                            <i memberId="<?php echo $rows['id']; ?>"
                                               class="fa fa-close fa-2x hide-member" aria-hidden="true" title="Hide"
                                            ></i>
                                        </div>
                                    ...
                                    <div class="user-icon-row">
                                        <div class="user-name-icon">
                                            <a href="javascript:void(0);"
                                               class="btn btn-info btn-xs btn_add_friend"><i class="fa fa-user-plus"
                                                                                             aria-hidden="true"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="browse_box">
                                            ...
                                            <div class="user-icon-row">
                                                <div class="user-name-icon">
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-info btn-xs btn_add_friend"><i
                ...
                <?php } ?>
                <div class="post-ad-form-container visible-xs">
                    <div class="post-ad-form">
                        <form role="form" method="post" action="<?php echo base_url('dashboard/postad'); ?>
							">
                            <a href="#" id="mobile_ads"><h5 class="post-ad-form-title">Click Here To Post
                                    Your Ads:</h5></a>
                            <div class="form_t_data">
                                <?php echo $this->
                                session->flashdata('success'); ?>
                                <div class="post-ad-form-group">
                                    <input type="text" name="ad_title" class="post-ad-form-control"
                        ...
                        <div class="wall-posts">
                            <form role="form" id="myForm" action="" enctype="multipart/form-data" method="post">
                                <ul class="nav nav-tabs" style="width: 96%">
                                    ...
                                    <li><a data-toggle="tab" href="#menu2">Add Video</a></li>
                                </ul>
                                ...
                                <textarea name="status" cols="87" id="status" rows="3"
                                    ...
                                    <div id="menu2" class="tab-pane fade" style="height: 71px;">
                                        <textarea name="video" cols="87" id="video" rows="3"
                                                  placeholder="Add video url"></textarea>
...
//        $('#myCarousel .carousel-inner').html('');
    ...
    $('.hide-member').click(function () {
        self = $(this);
        var parent = $(self.parents().eq(3));
        var userId = self.attr('memberId');
        swal({
            title: 'Are you sure?',
            text: "You are going to hide this user",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>dashboard/not_show_user_ajax',
                dataType: 'json',
...
<?= $this->load->view('/public/scripts/backToTopButton', null, true); ?>
</body>
</html>