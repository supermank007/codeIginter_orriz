    ...
    <div class="row">
        <div class="panel-body">
            <ul class="nav nav-tabs r-friend-tabs" style="border-bottom: 1px solid #ddd;" role="tablist">
                <li><a href="<?= base_url('dashboard/friends') ?>" style="background: none; color: #428bca">Friends</a></li>
                <li>
        ...
        <div class="col-sm-10">
            ...
            <?php if (isset($online_friend_list)) { ?>
                <div class="row row-no-padding">
                    <?php foreach ($online_friend_list as $rows) {
